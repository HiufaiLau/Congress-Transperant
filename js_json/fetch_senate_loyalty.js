...
function showTable() { //this is creating the whole table
	...
	var myTable = document.getElementById("partyVote"); //this new table will connect to html table id 
	...
	//table for most Loyal (Bottom 10% Attendance)
	var myTable = document.getElementById("mostLoyalVote");
	...
	var myTable = document.getElementById("lessLoyalVoteSenate")
